...
export class ConditionEvaluator {
  ...
  visitFirstLiteralToken = (context: Context, node: ts.Node) => {
    ...
    return this.z3Context.ToInt(Number(node.getText()));

    // return this.z3Context.Real() (Number(node.getText()));
  };

  visitTrueKeyword = (context: Context, node: ts.Node) => {
    console.log("Found TrueKeyword");
    return true;
  };

  visitFalseKeyword = (context: Context, node: ts.Node) => {
    console.log("Found FalseKeyword");
    return false;
  };
  ...
  visitAsteriskToken = (
    ...
    return this.visitCondition(context, leftNode).mul(
      this.visitCondition(context, rightNode)
    );
  };
  ...
  visitSlashToken = (
    ...
    return this.visitCondition(context, leftNode).div(
      this.visitCondition(context, rightNode)
    );
  };
  ...
  visitPlusToken = (
    ...
    return this.visitCondition(context, leftNode).add(
      this.visitCondition(context, rightNode)
    );
  };
  ...
  visitMinusToken = (
    ...
    return this.visitCondition(context, leftNode).sub(
      this.visitCondition(context, rightNode)
    );
  };
  ...
  visitPercentToken = (
    ...
    return this.visitCondition(context, leftNode).mod(
      this.visitCondition(context, rightNode)
    );
  };
}
